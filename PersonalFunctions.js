...
function characterSetUp()
{
	...
	switch(i)
	{
		...
		case 18:
		{
			document.getElementById("dilemmainfo1").innerHTML += "A horde of zombies is about to catch your party, you can push the individual into the horde to give your party time to escape. What do <b>you</b> do? "
			charamount = 0;
			//charamount1 to 3-5
			charamount1 = Math.floor((Math.random() * 3)+3);
...
function completeSurvey()
{
	...
	//INCLUDE BOTH MFQ RESULTS, INDIVIDUAL AND FOUNDATION TOTALS. REPLACE IN PARTICIPANTOBJ.	
	var irlmfqobject = [];
...
function TutLoad()
{
	...
	dilemmab.src = dilemmas[dilemma1];
		...
		document.getElementById("dilemmainfo").innerHTML += "The train is headed towards three people, pulling the lever will switch the track. What do <b>you</b> do?"
