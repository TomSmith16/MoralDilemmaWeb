...
function characterSetUp()
{
	...
	switch(i)
	{
		...
		{
			//Info
			document.getElementById("dilemmainfo1").innerHTML += "You and members of your town are hiding in the basement from invading soldiers, an individual is coughing uncontrollably and you will be found by the soldiers. \nWhat does <b>" + charactername +"</b> do?";
			//Baby
			charamount = 0;
		...
		case 18:
		{
			document.getElementById("dilemmainfo1").innerHTML += "A horde of zombies is about to catch your party, you can push the individual into the horde to give your party time to escape. What does <b>" + charactername +"</b> do? "
			charamount = 0;
			//charamount1 to 3-5
			charamount1 = Math.floor((Math.random() * 3)+3);
...
{
	document.getElementById("dilemmainfochar").innerHTML += "The train is headed towards three people, pulling the lever will switch the track. What does <b>" + charactername + "</b> do?"
}

function addCharacter()
{
	document.getElementById("chardo").style.textAlign = "center";
	document.getElementById("chardo").innerHTML += "<b>Please make a decision based on what " + charactername + " would do.</b><br>"
}
				...
				$("#survey").fadeOut(500, function() {
					...
					//if surveyfinished & mfqrandom = 1
						if(mfqrandom == 1)
						{
							...
							document.body.style.background = "url(bg.png)";
							$("#mfq").css("background-color", "#f2ffff");
							$("#mfq").fadeIn();
						}
						else
						{
							...
							document.body.style.background = "url(bg1.png)";
							$("#mfqgames").css("background-color", "#f2fff2");
							$("#mfqgames").fadeIn();
							//$("#participants").fadeIn()
						}
					})
...
//MFQ CONFIRM
	$("#mfqconfirm").click(function() {
			...
			//
			var harmcare = (mfqresults[0] + mfqresults[6] + mfqresults[11] + mfqresults[16] + mfqresults[22] + mfqresults[27])
			var fairrecip = (mfqresults[1] + mfqresults[7] + mfqresults[12] + mfqresults[17] + mfqresults[23] + mfqresults[28])
			var grouployal = (mfqresults[2] + mfqresults[8] + mfqresults[13] + mfqresults[18] + mfqresults[24] + mfqresults[29])
			var authrespect = (mfqresults[3] + mfqresults[9] + mfqresults[14] + mfqresults[19] + mfqresults[25] + mfqresults[30])
			var puresanc =(mfqresults[4] + mfqresults[10] + mfqresults[15] + mfqresults[20] + mfqresults[26] + mfqresults[31])
...
//MFQ GAMES CONFIRM
	$("#mfqgamesconfirm").click(function() {
			...
			//FOR EVERY INDIVIDUAL SCORE FROM THE MFQ
			mfqgameinputs = document.getElementsByClassName('mfqgameentry');
			for(var i=0; mfqgameinputs[i]; ++i)
			{
				//Adds every individual MFQ input to an array for firebase, could change to Harm/Care foundations instead?
				mfqgamesresults[mfqgamesnumber] = Number(mfqgameinputs[i].value);
				mfqgamesresults[mfqgamesnumber];
				console.log(mfqgamesresults[mfqgamesnumber]);
				mfqgamesnumber++;
				
			}
			
			//
			var gameharmcare = (mfqgamesresults[0] + mfqgamesresults[6] + mfqgamesresults[11] + mfqgamesresults[16] + mfqgamesresults[22] + mfqgamesresults[27])
			var gamefairrecip = (mfqgamesresults[1] + mfqgamesresults[7] + mfqgamesresults[12] + mfqgamesresults[17] + mfqgamesresults[23] + mfqgamesresults[28])
			var gamegrouployal = (mfqgamesresults[2] + mfqgamesresults[8] + mfqgamesresults[13] + mfqgamesresults[18] + mfqgamesresults[24] + mfqgamesresults[29])
			var gameauthrespect = (mfqgamesresults[3] + mfqgamesresults[9] + mfqgamesresults[14] + mfqgamesresults[19] + mfqgamesresults[25] + mfqgamesresults[30])
			var gamepuresanc =(mfqgamesresults[4] + mfqgamesresults[10] + mfqgamesresults[15] + mfqgamesresults[20] + mfqgamesresults[26] + mfqgamesresults[31])
...
function TutLoad()
{
	...
	if(mfqrandom == 0)
	{
		...
		document.getElementById("mfq").style.backgroundColor = "#f2ffff";
		//document.body.style.background = "url(bg.png)";
	...
	{
		document.getElementById("mfqgames").style.backgroundColor = "#f2fff2";
